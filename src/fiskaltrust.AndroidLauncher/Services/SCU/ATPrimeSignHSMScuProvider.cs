...
using fiskaltrust.Middleware.SCU.AT.PrimeSignHSM;
...
{
    class ATPrimeSignHSMScuProvider : IATSSCDProvider
    {
        public IATSSCD CreateSCU(PackageConfiguration scuConfiguration, Guid ftCashBoxId, bool isSandbox, LogLevel logLevel)
        {
            ...
            serviceCollection.AddAppInsights(Helpers.Configuration.GetAppInsightsInstrumentationKey(isSandbox), "fiskaltrust.Middleware.SCU.AT.PrimeSignHSM", ftCashBoxId);
