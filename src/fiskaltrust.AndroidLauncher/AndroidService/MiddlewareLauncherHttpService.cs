...
namespace fiskaltrust.AndroidLauncher.AndroidService
{
    ...
    public class MiddlewareLauncherHttpService : Service
    {
        ...
        public IHostFactory GetHostFactory() => new HttpHostFactory();

        public IUrlResolver GetUrlResolver() => new RestUrlResolver();

        public override IBinder OnBind(Intent intent)
        {
            var stopBroadcastReceiver = new StopHttpLauncherBroadcastReceiver();
            // Explicit cast of flags because of: https://github.com/xamarin/xamarin-android/issues/7503
            RegisterReceiver(stopBroadcastReceiver, new IntentFilter(BroadcastConstants.HttpStopBroadcastName), (ActivityFlags)ReceiverFlags.Exported);
            return null;
        }
        ...
        {
            if (!IsRunning(typeof(MiddlewareLauncherHttpService)))
            {
                ...
                Android.App.Application.Context.StartForegroundServiceCompat<MiddlewareLauncherHttpService>(bundle);
            }
        }
        ...
        public static void Stop()
        {
            ...
            if (IsRunning(typeof(MiddlewareLauncherHttpService)))
            {
                var intent = new Intent(Android.App.Application.Context, typeof(MiddlewareLauncherHttpService));
