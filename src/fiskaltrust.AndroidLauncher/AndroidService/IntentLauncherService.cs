...
namespace fiskaltrust.AndroidLauncher.AndroidService
{
    ...
    public class IntentLauncherService : Service
    {
        ...
        public override StartCommandResult OnStartCommand(Intent intent, StartCommandFlags flags, int startId)
        {
            ...
            try
            {
                ...
                var type = intent.GetStringExtra("launcher_type");
        ...
        {
            if (!IsRunning(typeof(IntentLauncherService)))
            {
                ...
                Android.App.Application.Context.StartForegroundServiceCompat<IntentLauncherService>(bundle);
            }
        }
        ...
        public static void Stop() 
        {
            ...
            if (IsRunning(typeof(IntentLauncherService)))
            {
                var intent = new Intent(Android.App.Application.Context, typeof(IntentLauncherService));
