...
{
    class ITEpsonRTPrinterSCUProvider : IITSSCDProvider
    {
        public IITSSCD CreateSCU(PackageConfiguration scuConfiguration, Guid ftCashBoxId, bool isSandbox, LogLevel logLevel)
        {
            ...
            // serviceCollection.AddAppInsights(Helpers.Configuration.GetAppInsightsInstrumentationKey(isSandbox), "fiskaltrust.Middleware.SCU.IT.EpsonRTPrinter", ftCashBoxId);
